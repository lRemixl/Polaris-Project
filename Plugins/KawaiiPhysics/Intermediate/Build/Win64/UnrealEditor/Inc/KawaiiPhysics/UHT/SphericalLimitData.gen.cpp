...
template<> KAWAIIPHYSICS_API UScriptStruct* StaticStruct<FSphericalLimitData>()
{
	...
	struct Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_SphericalLimitData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_SphericalLimitData_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_SphericalLimitData_h_76251866(TEXT("/Script/KawaiiPhysics"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_SphericalLimitData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_SphericalLimitData_h_Statics::ScriptStructInfo),
		nullptr, 0);
