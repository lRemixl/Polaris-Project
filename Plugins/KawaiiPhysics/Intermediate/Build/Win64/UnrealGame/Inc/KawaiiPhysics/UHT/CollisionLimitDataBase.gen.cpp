...
template<> KAWAIIPHYSICS_API UScriptStruct* StaticStruct<FCollisionLimitDataBase>()
{
	...
	struct Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_CollisionLimitDataBase_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_CollisionLimitDataBase_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_CollisionLimitDataBase_h_2855380042(TEXT("/Script/KawaiiPhysics"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_CollisionLimitDataBase_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_CollisionLimitDataBase_h_Statics::ScriptStructInfo),
		nullptr, 0);
