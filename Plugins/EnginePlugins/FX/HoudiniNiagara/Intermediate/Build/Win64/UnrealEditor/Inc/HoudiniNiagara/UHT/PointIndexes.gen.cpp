...
template<> HOUDININIAGARA_API UScriptStruct* StaticStruct<FPointIndexes>()
{
	...
	struct Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_PointIndexes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_PointIndexes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_PointIndexes_h_2773346562(TEXT("/Script/HoudiniNiagara"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_PointIndexes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_PointIndexes_h_Statics::ScriptStructInfo),
		nullptr, 0);
