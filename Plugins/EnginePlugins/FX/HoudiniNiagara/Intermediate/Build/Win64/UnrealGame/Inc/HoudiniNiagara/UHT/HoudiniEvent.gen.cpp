...
template<> HOUDININIAGARA_API UScriptStruct* StaticStruct<FHoudiniEvent>()
{
	...
	struct Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniEvent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniEvent_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniEvent_h_905700506(TEXT("/Script/HoudiniNiagara"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniEvent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_FX_HoudiniNiagara_Source_HoudiniNiagara_Public_HoudiniEvent_h_Statics::ScriptStructInfo),
		nullptr, 0);
