...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Marketplace_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraUIActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Marketplace_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraUIActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANiagaraUIActor, ANiagaraUIActor::StaticClass, TEXT("ANiagaraUIActor"), &Z_Registration_Info_UClass_ANiagaraUIActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANiagaraUIActor), 2427565526U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Marketplace_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraUIActor_h_4107301123(TEXT("/Script/NiagaraUIRenderer"),
		Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Marketplace_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraUIActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Marketplace_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraUIActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
