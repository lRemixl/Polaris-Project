...
template<> CRIWAREMOVIESCENES_API UScriptStruct* StaticStruct<FMovieSceneManaSectionTemplate>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneManaSectionTemplate_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneManaSectionTemplate_Statics::NewProp_Params_MetaData[] = {
		{ "AllowPrivateAccess", "TRUE" },
		{ "Category", "MovieSceneManaSectionTemplate" },
		{ "ModuleRelativePath", "Public/MovieSceneManaSectionTemplate.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneManaSectionTemplate_Statics::NewProp_Params = { "Params", nullptr, (EPropertyFlags)0x0040008000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMovieSceneManaSectionTemplate, Params), Z_Construct_UScriptStruct_FMovieSceneManaSectionParams, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneManaSectionTemplate_Statics::NewProp_Params_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneManaSectionTemplate_Statics::NewProp_Params_MetaData)) }; // 3527009288
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneManaSectionTemplate_Statics::ReturnStructParams = {
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneManaSectionTemplate()
	{
		...
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MovieSceneManaSectionTemplate.InnerSingleton, Z_Construct_UScriptStruct_FMovieSceneManaSectionTemplate_Statics::ReturnStructParams);
		}
		return Z_Registration_Info_UScriptStruct_MovieSceneManaSectionTemplate.InnerSingleton;
	}
	struct Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWareCinematics_Source_CriWareMovieScenes_Public_MovieSceneManaSectionTemplate_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWareCinematics_Source_CriWareMovieScenes_Public_MovieSceneManaSectionTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneManaSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneManaSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneManaSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneManaSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneManaSectionTemplate), 4189003556U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWareCinematics_Source_CriWareMovieScenes_Public_MovieSceneManaSectionTemplate_h_2625519063(TEXT("/Script/CriWareMovieScenes"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWareCinematics_Source_CriWareMovieScenes_Public_MovieSceneManaSectionTemplate_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWareCinematics_Source_CriWareMovieScenes_Public_MovieSceneManaSectionTemplate_h_Statics::ScriptStructInfo),
		nullptr, 0);
