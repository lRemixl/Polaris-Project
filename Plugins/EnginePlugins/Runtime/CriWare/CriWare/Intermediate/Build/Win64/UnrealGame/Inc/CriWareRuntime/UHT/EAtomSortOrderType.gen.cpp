...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_CriWareRuntime_EAtomSortOrderType_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_CriWareRuntime_EAtomSortOrderType_Statics::Enum_MetaDataParams[] = {
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CriWareRuntime_EAtomSortOrderType_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_CriWareRuntime_EAtomSortOrderType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CriWareRuntime_EAtomSortOrderType_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomSortOrderType_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomSortOrderType_h_Statics::EnumInfo[] = {
		{ EAtomSortOrderType_StaticEnum, TEXT("EAtomSortOrderType"), &Z_Registration_Info_UEnum_EAtomSortOrderType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1177361562U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomSortOrderType_h_27547173(TEXT("/Script/CriWareRuntime"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomSortOrderType_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomSortOrderType_h_Statics::EnumInfo));
