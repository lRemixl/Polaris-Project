...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDEPRECATED_MaterialExpressionManaMovieFormatSwitch_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
	...
	struct Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_MaterialExpressionManaMovieFormatSwitch_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_MaterialExpressionManaMovieFormatSwitch_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDEPRECATED_MaterialExpressionManaMovieFormatSwitch, UDEPRECATED_MaterialExpressionManaMovieFormatSwitch::StaticClass, TEXT("UDEPRECATED_MaterialExpressionManaMovieFormatSwitch"), &Z_Registration_Info_UClass_UDEPRECATED_MaterialExpressionManaMovieFormatSwitch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_MaterialExpressionManaMovieFormatSwitch), 3730351008U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_MaterialExpressionManaMovieFormatSwitch_h_1386959482(TEXT("/Script/CriWareRuntime"),
		Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_MaterialExpressionManaMovieFormatSwitch_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_MaterialExpressionManaMovieFormatSwitch_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
