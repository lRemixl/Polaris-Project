...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_CriWareRuntime_EAtomAudioVolumeType_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_CriWareRuntime_EAtomAudioVolumeType_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_CriWareRuntime_EAtomAudioVolumeType_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_CriWareRuntime_EAtomAudioVolumeType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_CriWareRuntime_EAtomAudioVolumeType_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomAudioVolumeType_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomAudioVolumeType_h_Statics::EnumInfo[] = {
		{ EAtomAudioVolumeType_StaticEnum, TEXT("EAtomAudioVolumeType"), &Z_Registration_Info_UEnum_EAtomAudioVolumeType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4011604900U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomAudioVolumeType_h_495538575(TEXT("/Script/CriWareRuntime"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomAudioVolumeType_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Runtime_CriWare_CriWare_Source_CriWareRuntime_Public_EAtomAudioVolumeType_h_Statics::EnumInfo));
