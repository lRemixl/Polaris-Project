...
template<> AKAUDIO_API UScriptStruct* StaticStruct<FAkMidiProgramChange>()
{
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAkMidiProgramChange_Statics::NewProp_ProgramNum = { "ProgramNum", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FAkMidiProgramChange, ProgramNum), nullptr, METADATA_PARAMS(Z_Construct_UScriptStruct_FAkMidiProgramChange_Statics::NewProp_ProgramNum_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAkMidiProgramChange_Statics::NewProp_ProgramNum_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_AkAudio_Public_AkMidiProgramChange_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_AkAudio_Public_AkMidiProgramChange_h_Statics::ScriptStructInfo[] = {
		{ FAkMidiProgramChange::StaticStruct, Z_Construct_UScriptStruct_FAkMidiProgramChange_Statics::NewStructOps, TEXT("AkMidiProgramChange"), &Z_Registration_Info_UScriptStruct_AkMidiProgramChange, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAkMidiProgramChange), 1889525778U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_AkAudio_Public_AkMidiProgramChange_h_2466124515(TEXT("/Script/AkAudio"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_AkAudio_Public_AkMidiProgramChange_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_AkAudio_Public_AkMidiProgramChange_h_Statics::ScriptStructInfo),
		nullptr, 0);
