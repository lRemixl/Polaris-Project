...
template<> WWISESIMPLEEXTERNALSOURCE_API UScriptStruct* StaticStruct<FWwiseExternalSourceCookieDefaultMedia>()
{
	...
	struct Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_WwiseSimpleExternalSource_Public_WwiseExternalSourceCookieDefaultMedia_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_WwiseSimpleExternalSource_Public_WwiseExternalSourceCookieDefaultMedia_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_WwiseSimpleExternalSource_Public_WwiseExternalSourceCookieDefaultMedia_h_4030211537(TEXT("/Script/WwiseSimpleExternalSource"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_WwiseSimpleExternalSource_Public_WwiseExternalSourceCookieDefaultMedia_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Freshy_Polaris_Project_main_Plugins_EnginePlugins_Wwise_Source_WwiseSimpleExternalSource_Public_WwiseExternalSourceCookieDefaultMedia_h_Statics::ScriptStructInfo),
		nullptr, 0);
