...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UPropertySerializer_Statics::NewProp_ObjectSerializer = { "ObjectSerializer", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UPropertySerializer, ObjectSerializer), Z_Construct_UClass_UObjectSerializer_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPropertySerializer_Statics::NewProp_ObjectSerializer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertySerializer_Statics::NewProp_ObjectSerializer_MetaData)) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UPropertySerializer_Statics::NewProp_PinnedStructs_Inner = { "PinnedStructs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UClass_UStruct, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPropertySerializer_Statics::NewProp_PinnedStructs_MetaData[] = {
		{ "ModuleRelativePath", "Public/Utilities/PropertyUtilities.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPropertySerializer_Statics::NewProp_PinnedStructs = { "PinnedStructs", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UPropertySerializer, PinnedStructs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPropertySerializer_Statics::NewProp_PinnedStructs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertySerializer_Statics::NewProp_PinnedStructs_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_JsonAsAsset_Source_JsonAsAsset_Public_Utilities_PropertyUtilities_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_JsonAsAsset_Source_JsonAsAsset_Public_Utilities_PropertyUtilities_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPropertySerializer, UPropertySerializer::StaticClass, TEXT("UPropertySerializer"), &Z_Registration_Info_UClass_UPropertySerializer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPropertySerializer), 3555315565U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_JsonAsAsset_Source_JsonAsAsset_Public_Utilities_PropertyUtilities_h_571227062(TEXT("/Script/JsonAsAsset"),
		Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_JsonAsAsset_Source_JsonAsAsset_Public_Utilities_PropertyUtilities_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SHORT_Polaris_Project_main_Plugins_JsonAsAsset_Source_JsonAsAsset_Public_Utilities_PropertyUtilities_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
